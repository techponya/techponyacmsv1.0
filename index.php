	...
	<div id="primary" class="content-area">
		...
		<div class="techponya row main-content-inner">
			<div class="col-md-12">
				...
				<!-- Techponya software Widget -->
				<div class='col-md-offset-2 type-post hentry col-md-12'>
						  <div class="carousel slide" data-ride="carousel" id="quote-carousel">
							...
							<div class="carousel-inner">
								...
								<blockquote>
								  <div class="row">
									<div class="col-sm-3 text-center">
									  <img class="img-circle" src="<?php echo techponya_url(); ?>userfiles/konten/<?php echo $techponya[4];?>" style="width: 100px;height:100px;">
									</div>
									<div class="col-sm-9">
							  ...
							  <!-- Quote 2 -->
							    <?php 
											$sql_fadlhymj = "SELECT * FROM artikel ORDER BY RAND() LIMIT 5";
											$hasil_fadlhymj = mysql_query($sql_fadlhymj,$dbconn);
											while ($techponya = mysql_fetch_array($hasil_fadlhymj)){ 
										?>
							  <div class="item">
								<blockquote>
								  <div class="row">
									...
									<div class="col-sm-9">
									  <p><?php custom_echo($techponya[2], 80); ?></p>
									  <small><?php echo $techponya[1];?></small>
									</div>
								  </div>
								</blockquote>
							  </div>
